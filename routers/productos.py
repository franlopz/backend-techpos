...
async def create(productos:List[ProductoModel], current_user: User = Depends(get_current_active_user), uuid: Optional[str] = Header(None)):
     temp = []
     for producto in productos:
         temp.append(producto.dict())
    #     print(producto.producto)
     return await bulk_producto(temp,current_user, uuid)
